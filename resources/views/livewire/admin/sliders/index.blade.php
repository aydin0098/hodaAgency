                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        ...
                                        <form wire:submit.prevent="store" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail111">نوشته اول اسلایدر:</label>
                                                <input type="text" wire:model.lazy="title_text"
                                                       class="form-control" id="exampleInputEmail111">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail111">نوشته دوم اسلایدر:</label>
                                                <input type="text" wire:model.lazy="description_text"
                                                       class="form-control" id="exampleInputEmail111">
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="datatable-buttons"
                                        ...
                                        <thead>
                                        <tr role="row">
                                            <th class="sorting_asc">عنوان اسلایدر</th>
                                            <th class="sorting">تصویر</th>
                                            <th class="sorting">متن نوشته اول</th>
                                            <th class="sorting">متن نوشته دوم</th>
