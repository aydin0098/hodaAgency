            ...
            <div class="row">
                <div class="col-12">
                    <div class="bread-inner">
                        ...
                        <!-- Bread Title -->
                        <div class="bread-title"><h2>صدا و سیما</h2></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                    <div class="section-title default text-center">
                        ...
                        <div class="section-bottom">
                            <div class="text">
                                <p class="text-center">برای استعلام قیمت لطفا شبکه خود را انخاب کنید .</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="single-slider">
                                ...
                                <div class="single-news">
                                    <div class="news-head overlay" style="width: 30%">
                                        <span class="news-img" style="background-image:url('{{asset($p->image)}}');width: 90%;height: 90%"></span>
                                    </div>
                                    <div class="news-body" style="width: 30%">
                                        <div class="news-content">
                                            <h3 class="news-title"><a href="#">{{$p->title}}</a></h3>
                                            <div class="news-text">
                                                <a style="padding: 7px 6px" href="{{route('tv.price',['category'=>$category->id,'network'=>$p->id])}}" class="bizwheel-btn"><i class="fa fa-angle-left"></i>لیست قیمت</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
