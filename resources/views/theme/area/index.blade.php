            ...
            <div class="row">
                <div class="col-12">
                    <div class="bread-inner">
                        ...
                        <!-- Bread Title -->
                        <div class="bread-title"><h2>رسانه محیطی</h2></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12">
                            <div class="blog-single-main">
                                ...
                                <div class="blog-detail">
                                    <h2 class="blog-title">رسانه محیطی</h2>
                                ...
                                <div class="single-team">
                                    ...
                                    <div class="t-content">
                                        <div class="content-inner">
                                            <h4 class="name"><a href="{{route('area.province',$b->id)}}">{{$b->title}}</a></h4>
                                            <a class="btn" href="{{route('area.province',$b->id)}}"><i class="fa fa-arrow-circle-o-left"></i>استعلام قیمت</a>
                                        </div>
                                    </div>
                                </div>
                                <!--/ End Single Team -->
