                ...
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                    <div class="section-title default text-center">
                        <div class="section-top">
                            <h1><b>استان {{$province->name}}</b></h1>
                        </div>
                        <div class="section-bottom">
                            <div class="text">
                                <p class="text-center">برای استعلام قیمت لطفا شهر خود را انخاب کنید .</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="single-news">
                                    ...
                                    <div class="news-body" style="width: 30%">
                                        <div class="news-content">
                                            <h3 class="news-title"><a href="#">{{$p->name}}</a></h3>
                                            <div class="news-text">
                                                <a style="padding: 7px 6px" href="{{route('area.price',['city' => $p->id,'service' => $service->id])}}" class="bizwheel-btn"><i class="fa fa-angle-left"></i>مشاهده قیمت</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
